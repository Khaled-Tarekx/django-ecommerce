...
class PaymentView(View):
        ...
        if order.billing_address:
            ...
            if userprofile.one_click_purchasing:
                cards = stripe.Customer.list_sources(
                    id=userprofile.stripe_customer_id,
                    limit=3,
                    object='card'
                )
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            messages.warning(self.request, f"AuthenticationErro")
            return redirect('/')
            ...
            messages.warning(self.request, f"StripeError")
            return redirect('/')

        except Exception as e:
            messages.warning(self.request, f"A serious error occured")
            return redirect('/')
...
class ItemDetailView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            messages.error(
                self.request, "You already have that item in your cart")
            return redirect("/")
